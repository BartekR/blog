...
rem %SAXONPATH%\Transform -s:01.xml -xsl:01.xsl -o:01.svg
rem %SAXONPATH%\Transform -s:02.xml -xsl:02.xsl -o:02.svg
rem %SAXONPATH%\Transform -s:03.xml -xsl:03.xsl -o:03.svg
